                ...
                <div className="flex-1 flex flex-col overflow-hidden bg-white dark:bg-background rounded-lg border">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">{messages.length} Pesan</p>
                        </div>
                    </div>
                                            ...
                                            <div className="flex gap-4">
                                                <div className="w-8 h-8 shrink-0 mt-1">
                                                    {msg.role === "assistant" ? (
                                                        ...
                                                        text-primary flex items-center justify-center ring-1 
                                                        ring-primary/20">
                                                            <Bot className="w-5 h-5" />
                                                        </div>
                                                    ) : (
                                ...
                                {isTyping && (
                                    ...
                                    >
                                        <div className="w-8 h-8 shrink-0">
                                            <div className="w-8 h-8 rounded-full bg-primary/10 text-primary flex
                        ...
                        >
                            <div className="flex-1 relative group">
                                <textarea
                                    ...
                                    placeholder={
                                        isChatPaused ? "Selesaikan Aktivitasnya untuk melanjutkan..." : "Tanya aku apa saja..."
                                    }
                                    className={cn(
